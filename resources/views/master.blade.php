      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="form">Form Obat</a></li>
              <li><a href="formpesan">Form Pemesanan</a></li>
              <li><a href="formjual">Form Penjualan</a></li>
              <li><a href="formbeli">Form Pembelian</a></li>
            </ul>
          </li>
          <li class="sub-menu">
            <a href="javascript:;">
            ...
            <ul class="sub">
              ...
              <li><a href="pesan">Data Pemesanan</a></li>
